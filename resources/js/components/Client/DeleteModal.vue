...
<template>
    <div id="delete-modal" tabindex="-1"
        class="hidden bg-[rgba(0,0,0,0.35)] overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 flex justify-center items-center w-full md:inset-0 max-h-full">
