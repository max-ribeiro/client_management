            ...
            <div class="bg-white rounded-xl shadow">
                ...
                <div class="flex flex-row items-center justify-between p-[16px]">
                    <div class="flex items-center w-1/3">
                        <label for="default-search" class="sr-only">Buscar contato</label>
                        <div class="relative w-80 h-9">
                            ...
                            <input type="search" id="default-search" placeholder="Buscar contato" v-model="searchText"
                    ...
                    <div class="flex items-center gap-[16px]">
                        <export-to-csv element="clients-table" :filename="getFileName()">
                            <base-button variant="secondary" icon="true" class="flex flex-row" title="exportar CSV">
                                <export-icon fill="#505050" class="w-[16px]"></export-icon> CSV
                            </base-button>
                        </export-to-csv>
